...
Currently building **Scanna**, an agent-native intelligence layer for prediction markets: real-time signals, forecasts, and on-chain forensics for autonomous trading agents and funds.

I also run AI consulting at **Etherian**.
